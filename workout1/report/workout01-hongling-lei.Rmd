...
## Introduction
A big fan of basketball? 
Sure, who in California doesn't like our legendary Golden State Warriors! ^[1]^
...
```{r out.width = '80%', echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../images/andre-iguodala-photo.jpg")
```
...
```{r out.width = '80%', echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../images/draymond-green-photo.jpg")
```
...
```{r out.width = '80%', echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../images/kevin-durant-photo.jpg")
```
...
```{r out.width = '80%', echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../images/klay-thompson-photo.jpg")
```
...
```{r out.width = '80%', echo = FALSE, fig.align = 'center'}
knitr::include_graphics("../images/stephen-curry-photo.jpg")
```
...
## References
^[1]^ [Photo of Golden State Warriors](https://onairstory.com/the-golden-state-warriors-are-rumored-to-be-resigning-andrew-bogut-in-the-team/)

^[2]^ [Golden State Warriors, Adam Augustyn, 2019](https://www.britannica.com/topic/Golden-State-Warriors)

^[3]^ [Andre Iguodala's photo](https://tucson.com/andre-iguodala/article_2f347934-c9c1-11e4-8664-4b3cb77c1e79.html)

^[4]^ [Draymond Green's photo](https://www.sbnation.com/nba/2018/11/14/18094749/draymond-green-kevin-durant-bitch-suspension-warriors-gmib)

^[5]^ [Kevin Durant's photo](https://sports.yahoo.com/kevin-durant-injured-ankle-left-early-in-golden-state-warriors-loss-to-phoenix-suns-030123926.html)

^[6]^ [Klay Thompson's photo](https://basketballsocietyonline.com/klay-thompson-warriors-nba)

^[7]^ [Stephen Curry's photo](https://www.blackenterprise.com/under-armour-releases-new-orleans-inspired-shoe-for-stephen-curry/)
