...
$$d(\textbf{p,q}) = d(\textbf{q,p}) = \sqrt{(q_1-p_1)^2 + (q_2-p_2)^2+...+(q_n-p_n)^2}$$
...
$$\left\|\textbf{p}\right\| = \sqrt{(p_1^2 + p_2^2 +...+p_n^2)} = \sqrt{\textbf{p}\cdot \textbf{p}},$$
